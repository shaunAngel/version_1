...
def generate_pdf(name, data):
    ...
    # ===== PHOTO (TOP RIGHT) =====
    img_x, img_y, img_w, img_h = 150, 25, 30, 35
    pdf.set_draw_color(0, 0, 0)
    pdf.rect(img_x, img_y, img_w, img_h)  # border
    ...
    # keep text left so it doesn't collide with image
    ...
    draw_bar("Math", data['math'], (34, 139, 34))
    draw_bar("Science", data['science'], (255, 165, 0))
    draw_bar("English", data['english'], (34, 139, 34))
    ...
    # ===== TEACHER FEEDBACK (4 lines EXACT) =====
    ...
    pdf.multi_cell(
        0, 6,
        "Akash shows consistent academic performance across subjects.\n"
